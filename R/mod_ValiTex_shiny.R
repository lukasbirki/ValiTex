...
mod_ValiTex_shiny_ui <- function(id){
  ns <- NS(id)
...
#' ValiTex_shiny Server Functions
#'
#' @noRd
...
# mod_ValiTex_shiny_ui("ValiTex_shiny_1")

## To be copied in the server
# mod_ValiTex_shiny_server("ValiTex_shiny_1")
